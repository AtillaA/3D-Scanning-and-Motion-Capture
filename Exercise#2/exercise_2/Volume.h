...
public:
	...
	inline uint getPosFromTuple(int x, int y, int z) const { return x * dy * dz + y * dz + z; }
...
private:
	//! x,y,z access to vol*
	inline double vol_access(int x, int y, int z) const { return vol[getPosFromTuple(x, y, z)]; }
};
